...
for i in `seq 2 $1`;
do
	python main.py e experiments/gifford_enash$i.rml -v> experiments/temp.txt
	#echo $i
	...
	echo "$i;$Ptime;$Cstr;$PGstr;$EmC;$GParS;$GParE;$TTPGS;$TTPGE;$Total " >> experiments/exetime_replica_control_enash.txt
done
