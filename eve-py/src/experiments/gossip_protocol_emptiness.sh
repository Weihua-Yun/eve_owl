...
for i in `seq 2 $1`;
do
	python main.py n experiments/gossip_protocol$i.rml -v> experiments/temp.txt
	#echo $i
	...
	echo "$i;$Ptime;$Cstr;$PGstr;$EmC;$GParS;$GParE;$TTPGS;$TTPGE;$Total " >> experiments/exetime_gossip_protocol_emptiness.txt
done
