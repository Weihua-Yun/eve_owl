...
for i in `seq 1 $1`;
do
	python main.py n experiments/bisim_none$i.rml -v > experiments/temp.txt
	#echo $i
	...
	echo "$i;$Ptime;$Cstr;$PGstr;$EmC;$GParS;$GParE;$TTPGS;$TTPGE;$Total " >> experiments/exetime_bisim_none_emptiness.txt
done
